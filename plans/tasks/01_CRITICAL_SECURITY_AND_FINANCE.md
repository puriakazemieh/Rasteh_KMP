...
- **2026-08-08 commits:** client implementation and plan completion `61d4c86`; server Task 01 migrations and security/payment regression coverage `8c860b4`. Local generated artifacts, Gradle caches, and machine-local SDK configuration were deliberately excluded from commits.
