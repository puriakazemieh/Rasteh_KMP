    ...
    NavHost(
        ...
        composable<Screen.HomeGraph> {
            ...
            MainGraphScreen(
                ...
                navigateToRastehSearch = { rastehId, rastehLabel, locationId, locationName ->
        ...
        composable<Screen.Warranty> {
            WarrantyScreen(navigateBack = { navController.navigateBack() })
        }
        ...
        composable<Screen.Deals> {
            DealsScreen(navigateBack = { navController.navigateBack() })
        }

        composable<Screen.PriceAlerts> {
            PriceAlertsScreen(navigateBack = { navController.navigateBack() })
        }
