...
> این سند تاریخچه و برنامهٔ پیاده‌سازی پیشین است. منبع حقیقت production-readiness از 2026-08-05: [`plans/README.md`](./plans/README.md) و [`docs/product/MVP_SCOPE.md`](./docs/product/MVP_SCOPE.md). قابلیت‌های مالی/تراکنشیِ این سند تا تصمیم و evidence جدید، disabled-by-default هستند.
